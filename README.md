...
- **Training** — a random handful of the cards you struggle with most. With an
  empty queue it takes the home screen's main button and collecting a new pack
  steps back to a secondary one. They are graded like any review: an early
